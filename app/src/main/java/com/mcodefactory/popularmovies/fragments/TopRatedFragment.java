...
public class TopRatedFragment extends Fragment implements RVAdapter.RVAdapterOnClickHandler {
    ...
    public void onAttach(Context context) {
        ...
        try {
            ...
            throw new ClassCastException(context.toString() + " needs to implement the OnSelectMovieListener");
        }
    }
